...
def print_death_age(people_dict: dict):
    ...
    Return: nothing
    """
    [print(value[NAME_INDEX], value[DEATH_YEAR_INDEX] - value[BIRTH_YEAR_INDEX]) for _, value in people_dict.items()]


def count_genders(people_dict: dict):
...
def print_marriages(marriages_dict: dict, people_dict: dict):
    ...
    for _, value in marriages_dict.items():
        ...
        husband_age = wedding_year  - people_dict[value[HUSBAND_KEY_INDEX]][BIRTH_YEAR_INDEX]
        wife_name = people_dict[value[WIFE_KEY_INDEX]][NAME_INDEX]
        wife_age = wedding_year - people_dict[value[WIFE_KEY_INDEX]][BIRTH_YEAR_INDEX]
