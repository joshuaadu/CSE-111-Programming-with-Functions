...
def get_adjective():
    ...
    from this list of adjectives:
        ...
        "chubby", "clean", "dazzling", "elegant", 
        "fancy", "glamorous"

    Return: a randomly chosen preposition.
    """
    adjectives = ["attractive", "bald", "beautiful", "chubby", "clean", "dazzling", "elegant", "fancy", "glamorous"]
...
def make_sentence(quantity, tense):
    ...
    sentence = f"{determiner} {adjective} {noun} {verb} {prepositional_phrase_1} {prepositional_phrase_2}".capitalize()
    return sentence
