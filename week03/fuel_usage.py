def main():
    ...
    mpg = miles_per_gallon(start_odometer, ending_odometer, fuel_amount)
...
def miles_per_gallon(start_miles: int | float, end_miles: int | float, amount_gallons: int | float) :
...
def lp100k_from_mpg(mpg: int | float):
